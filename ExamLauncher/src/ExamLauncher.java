...
public class ExamLauncher {
	...
	public static void main(String[] args) {
		...
		if ("0201".equals(s)) {
			...
			Ex0204.launch(); //ввести число N. Затем можно push число, pop число или max. На максах будут выводы
			...
			Ex0603.launch(); //ввести строки из условия слева направо сверху вниз. Будет вывод
		}
	}
}