...
public class Application {
	...
	private static final String FACILITIES =
				...
				"0 -> create new user;" + " 1 -> Choose payment method;" + "2 -> Choose user;" + "3 -> Cancel user selection;" + "4 -> Print users;" + "5 -> Print selected user;" + " 6 -> Print current user payment methods;" + "7 -> Search by payment method;" + "99 -> Exit;";
	...
	private void handleChoosePaymentMethod() {
		if (currentUser.name.isEmpty()) {
			...
			System.out.println(" 0 -> add PayPal" + "1-> add Erip" + "2 -> add Card");
	...
	private void search() {
		if (currentUser.name.isEmpty()) {
			...
			System.out.println("0 -> PayPal" + "1-> Erip" + "2 -> Card");
			switch (console.nextInt()) {
			case 0: {
