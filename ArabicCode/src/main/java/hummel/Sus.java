...
public class Sus implements ActionListener {
	...
	public void حددزر(JButton جبوتون) {

		Map<JButton, عمليةالتعداد> واحد = new HashMap<>();
		واحد.put(زر[23], عمليةالتعداد.مضروب);
		واحد.put(زر[44], عمليةالتعداد.حقيقةمزدوجة);
	...
	public void احسب() {
		...
		case حقيقةمزدوجة:
			long نتيجة2 = 1;
			for (Long عددصحيح = Math.round(المدخلات1); عددصحيح > 0; عددصحيح = عددصحيح - 2) {
				نتيجة2 = نتيجة2 * عددصحيح;
			}
			الناتج = نتيجة2;
			break;
		case مضروب:
	...
	public enum عمليةالتعداد {
		لاغية, أركوسينوس, أركتانجنت, أركسين, أركتغ, كوس, كتغ, تقسيم, مضروب, اللوغاريتم, ناقص, متعددة, النسبةالمئوية, زائد, قوة, الخطيئة, الجذرالتربيعي, تيجي, مربع, مكعب, إلجي, في, تش, ش, ال, كث, عشرة, رجوع, حقيقةمزدوجة;
	}
}